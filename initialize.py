...
log_file_path = "/home/vendingmachine/logs_count/startup.log"
...
def log_message(message):
    ...
    try:
        with open("/home/vendingmachine/logs_count//startup.log", "a") as log_file:
...
def get_blender_position():
    try:
        with open("/home/vendingmachine/logs_count/blender_status.txt", "r") as file:
...
def get_gantry_position():
    try:
        with open("/home/vendingmachine/logs_count/gantry_status.txt", "r") as file:
            return file.read().strip()
    except FileNotFoundError:
        return None
